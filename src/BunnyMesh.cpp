...
Model Bunny::model() {
	...
	std::vector<glm::vec4> vec_vertices;// = std::vector(bunny_mesh::modelVertices, bunny_mesh::modelVertices + vx_size);
	std::vector<glm::vec3> vec_normals;// = std::vector(bunny_mesh::modelVertices, bunny_mesh::modelVertices + vx_size);
	std::vector<uint32_t> vec_indices;// = std::vector(bunny_mesh::modelIndices, bunny_mesh::modelIndices + i_size);
